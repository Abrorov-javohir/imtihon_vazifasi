...
""";
  ...
  Future<List<Harajatlar>> get() async {
    final List<Harajatlar> harajatlar = [];
    // ignore: unused_local_variable
    final data = await _database.query(_dbtable);
    // ignore: unused_local_variable
    for (var index in harajatlar) {
      final harajatlarqoshish = Harajatlar(
      ...
      harajatlar.add(harajatlarqoshish);
    }
    return [...harajatlar];
  }
